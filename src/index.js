...
const APIrequestPinpo_1 = require("./APIrequestPinpo");
...
app.get('/config', express_1.default.urlencoded({ extended: true }), (req, res) => {
    res.send(`<html>
        <body>
...
app.post('/configsetup', express_1.default.urlencoded({ extended: true }), (req, res) => {
    ...
    fs_2.default.writeFile('config.json', jsonString, 'utf8', (err) => {
        if (err) {
            res.send(`<html>
                <body>
...
app.post('/sendLead', express_1.default.urlencoded({ extended: true }), (req, res) => {
    ...
    (0, APIrequestPinpo_1.sendLead)(prenom, nom, telephone.replace(/\+/g, ""), email, region, provider, product, product_id, externalIDContact, product_city, product_cp, product_dep)
        .then(() => {
